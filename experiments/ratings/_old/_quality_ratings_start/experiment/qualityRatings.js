...
// LOG RESPONSE
    log_response: function() {
        ...
        // Slider starts at zero; acceptable values are 1:20 so it must be greater than 0 to advance...
        if (response > 0) {
	...
	next: function() {
		...
		$("#progress").attr("style","width:" +
			...
			if (trial_info.slide == "qualityRatings") {
