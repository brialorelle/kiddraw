---
title: "ObjectGame Sketch Selection"
author: ""
date: "6/19/2019"
...
drawings_to_exclude_4 = read_csv(file = 'images_to_exclude/images_to_exclude_cdm_run_v5_objectgame.txt', col_names = FALSE) %>%
  as.tibble() %>%
  mutate(sketchName = X1) 
...
drawings_to_exclude <- drawings_to_exclude_1 %>%
  ...
  full_join(drawings_to_exclude_4)
...
categories = c('a bottle','a hat','a lamp','a cup')
