...
// set up feedback audio
var instructions = new Audio("audio/tap_vehicle_picture.wav");
instructions.volume = 1;

var sketch_instructions = new Audio("audio/tap_vehicle_drawing.wav");
...
window.onload = function() {
    ...
    categories = ['boat','airplane','train','car'] // vehicles
    ...
    $.ajax({
        ...
        success: function(data) {
                ...
                sketch_categories = ['airplane','boat','car','train'] 
