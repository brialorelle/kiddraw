...
$D(d)_{ij} = \frac{\sqrt{\sum_{i=1}^n (\vec{r}_{i}-\vec{r}_{j})^2}} {\sqrt{0.5 * (s_{i}^2 + s_{j}^2})},$ where $D$ represents the distinctiveness between the $i$th and $j$th object categories, $\vec{r}_{i}$ and $\vec{r}_{j}$ are their mean feature vectors, respectively, and where $s$ represents the category dispersion. 
