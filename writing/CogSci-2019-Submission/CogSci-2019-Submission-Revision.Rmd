...
These age-related changes in classification accuracy show that the underlying feature representations of older children's drawings were more linearly discriminable. This finding led us investigate a potential source of this enhanced discriminability: that drawings from different categories were spread further apart in feature space, while drawings within a category were clustered closer together. To evaluate this possibility, we used a measure of pairwise category distinctiveness $D_{ij}$ that accounts for both the distance between each pair of categories, as well as the dispersion within each category. We found that category distinctiveness increased consistently with age (Figure \ref{fig:distinctiveness}). 
