...
In order to estimate these weights, we collected quality ratings from adult observers (N=70) for 1222 tracings (i.e., 50-80 tracings per shape per age), each of which was rated 1-4 times. Raters were instructed to evaluate “how well the tracing matches the target shape and is aligned to the position of the target shape” on a 5-point scale. 
