...
# Introduction
One of our oldest uniquely human behaviors is drawing: cave decorations in Cauvet and Lascaux [@bataille1955lascaux; @chalmin2004blasons] have been dated to 40,000 years old  [@pike2012u;@valladas1992direct] and cotains drawings likely made by both children and adults [@sharpe2006study]. What do drawings reveal about the way we represent the world around us--and how might this change throughout childhood? For example, consider what one has to do in order to draw a phone – one needs to access the mental representation of “a phone”, distill this into a pictorial format, and plan a sequence of hand movements to effectively communicate this visual concept. Our drawings of objects tend to reflect our experience with them: for example, the phones that we might draw today (e.g., smart phones) are quite different from the phones drawn even twenty years ago (e.g., landline phones). 

Recent work also suggests that drawings are tightly linked to the same internal representations that allow us to recognize objects over dramatic changes in lighting, pose, and orientation. Recent computational work supports this intuition by comparing representations for drawings and photographs in a deep neural network models trained to recognize objects.  on photographs can also recognize drawings made by non-expert adults, as drawings and photographs generate similar representations in later layers of these models [@fan2015common]. In other words, drawings capture high-level perceptual similarity relationships between object categories: two objects that are perceptually similar (e.g., cups and mugs) are likely to be drawn in similar ways. Drawings and photographs of object categories may draw on common, internal object representations that support both production and recognition. Adults both prefer view photographs of objects and to draw objects relative to their size in the real-world, suggesting that the way in which we experience object categories is directly reflected in our drawings of them  [@konkle2011canonical]. 
