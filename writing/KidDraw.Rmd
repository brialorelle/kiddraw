...
```{r layerWise, fig.env = "figure", fig.pos = "H", fig.align='center', fig.width=4, fig.height=4, set.cap.width=T, num.cols.cap=1, fig.label="headcam", fig.cap = "Between-cohort similarity "}
