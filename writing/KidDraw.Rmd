...
Furthermore, ample evidence suggests that children's object recognition abilities continue to develop well throughout later childhood, specifically in the domains of configural and holistic processing (@juttner2016) For example,  while young children have a  bias to categorize novel objects on the basis of part-specific information, older children rely more on the relationship between the object parts [@mash2006]; and even older children have difficulty detecting changes in the propotions of an object's parts in familiar categories (i.e., animals; @Juttner2013; @davidoff2002).
