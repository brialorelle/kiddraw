...
Our goal was to measure semantic information in children's drawings, but we anticipated that their drawings may also vary along other dimensions more directly related to the motor production demands of the task, such as the amount of time spent drawing, the number of strokes used, and amount of ink (i.e., mean pixel intensity of sketch). See Figure \ref{fig:covDescriptives}.
