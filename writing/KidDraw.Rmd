...
abstract: 
    "How do children's represtations of object categories change as they grow older? Children are prolific artists, drawing both imagined and experienced objects from an early age. Here, we examine children's drawings as a window into how children represent objects. We asked children (ages 3-10 years) to draw a wide range of objects (e.g. 'can you draw a chair?') on an iPad. Then, we analyzed how these drawings change across childhood. We found that children became increasingly skilled at producing drawings that were recognizable to naïve adults, even when controlling for the amount of children spent drawing. Next, we quantified the perceptual similarity between children's and adult's drawings using the feature representations in a hiearchical convolutional neural network trained to recognize objects. Overall, we find that children's drawings were most similar to adult's drawings in later layers of the network, suggesting that children and adult's drawings capture perceptual features useful for recognition. Broadly, these results point towards drawing as a promising avenue for investigating object representations in childhood."
...
# Introduction
One of our oldest human behaviors is drawing: cave decorations have been dated to 40,000 years old  [@pike2012u;@valladas1992direct] in caves such as Cauvet and Lascaux  [@bataille1955lascaux; @chalmin2004blasons] with drawings likely made by both children and adults [@sharpe2006study]. What do drawings reveal about the way we represent the world around us?

For example, consider what one has to do in order to draw a phone – one needs to access the mental representation of “a phone”, distill this into a pictorial format, and plan a sequence of hand movements to effectively convey this visual concept. The drawings we produce tend reflect how we experience different object categories. For example, adults tend to draw objects relative to their size in the real-world:  objects that are big in the real-world (e.g., cars) tend to take up more "space" on a canvas than objects that are small in the real-world (e.g., cups) [@konkle2011canonical]. 

Furthermore, in order to be recognizable, drawings have to depict the necessary visual features to express a given visual concept. Recent computational work supports this intuition: deep neural network models trained purely on photographs can also recognize drawings made by non-expert adults, as drawings and photographs generate similar representations in later layers of these models [@fan2015common]. In other words, drawings capture high-level perceptual similarity relationships between object categories: two objects that are perceptually similar (e.g., cups and mugs) are likely to be drawn in similar ways.

Here, we investigate children’s drawings as a window into how children represent object categories and their similarity structure. While one might intuit that children’s category representations are relatively mature by the preschool years, children's ability to recognize objects continue to mature into early adolescence (for reviews, see @nishimura2009; @juttner2016developmental). For example, children have trouble recognizing objects across dramatic changes in viewpoint and lighting until almost 12 years of age [@bova2007;@dekker2011dorsal]. Children's ability to process the relationship between objects' parts also has a protracted developmental trajectory: while young children have a bias to categorize novel objects on the basis of part-specific information, older children rely more on the relationship between the object parts [@mash2006]; and even older children have difficulty detecting changes in the proportions of an object's parts in familiar categories (i.e., animals; [@juttner2014late; @juttner2013developmental; @davidoff2002]). Further, young children have a hard time understanding the correspondence between two-tone images (i.e, Mooney images) and the photographs that they were generated from--something that is natural and effortless for adults [@Yoon2011]. Thus, children’s representations of object categories may also may also be shifting throughout childhood.

While drawing has been extensively studied in early childhood, a primary focus has been on when and how children treat drawings as symbolic [@gardner1994arts], and evidence now suggests that young children do attribute rich meanings to their drawings. For example, children will attribute different symbolic content (e.g., “a balloon”, “a lollipop”) to very similar drawings based on what they intended to draw [@bloom1998intention] and will monitor whether their drawings are adequate symbols for the things they are trying to draw [@callaghan1999early]. However, to our knowledge, no research has examined whether children's drawings reflect how they are representing objects in the world around them.
