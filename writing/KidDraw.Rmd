...
## Results
We examined the feature similarities between sketches produced by adults and children at each layer of VGG-19. For older children, we found that the similarity between drawings made by children and adults increased as a function of model layer, reaching a peak in the final layers (see Figure \ref{fig:layerWise}). For younger children, we found a noisier pattern of results, as similarity to adult drawings was lower overall in higher layers. However, due to the small size of our current dataset, we caution against strong interpretations of particular layer-wise estimates. Nonetheless, adults' and children's drawings were dissimilar in pixel space for both age groups (adults vs. older children, r = .06; vs. younger children, r = .02). 
