...
```
Here, we explore the perceptual schemas that children associate with object categories and how these change over childhood by examining what amd how children draw. First, we examine if children produce more recognizable drawings as they get older after factoring out low-level covariates. Second, we compare the perceptual features of child and adult drawings by comparing their representations in a deep convolutional neural network trained to recognize objects. Together, this work begin a developmental project to investigate children's internal representations of object categories and how they are linked to their developing perceptual abilities.
