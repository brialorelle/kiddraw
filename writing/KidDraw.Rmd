...
Here we investigate children’s drawings as a window into how children represent object categories and their similarity structure. While one might intuit that children’s category representations are relatively mature by the preschool years, children's ability to recognize objects continue to mature into early adolescence (for reviews, see @nishimura2009; @juttner2016developmental). For example, children have trouble recognizing objects across dramatic changes in viewpoint and lighting until almost 12 years of age [@bova2007;@dekker2011dorsal]. Children's ability to process the relationship between parts of objects also has a protracted developmental trajectory: while young children have a bias to categorize novel objects on the basis of part-specific information, older children rely more on the relationship between the object parts [@mash2006]; and even older children have difficulty detecting changes in the proportions of an object's parts in familiar categories (i.e., animals; [@juttner2014late; @juttner2013developmental; @davidoff2002]). Further, young children have a hard time understanding the correspondence between two-tone images (i.e, Mooney images) and the photographs that they were generated from--something that is natural and effortless for adults [@yoon2011thinking]. Thus, children’s representations of object categories may also may also be shifting throughout childhood.

While drawing has been extensively studied in early childhood, a primary focus has been on when and how children treat drawings as symbolic [@deloache1987rapid; @gardner1994arts], and evidence now suggests that young children do attribute rich meanings to their drawings. For example, children will attribute different symbolic content (e.g., “a balloon”, “a lollipop”) to very similar drawings based on what they intended to draw [@bloom1998intention] and will monitor whether their drawings are adequate symbols for the things they are trying to draw [@callaghan1999early].

<!--
Re: "However, to our knowledge, no research has examined whether children's drawings reflect how they are representing objects in the world around them."

JEF: I'm of two minds about citing [@kosslyn1977children] here, on grounds that it might be distracting. But it is responding to earlier (not super empirical) arguments by [@minsky1972artificial] that children's drawings can provide a direct window into children's internal representations. maybe if not "object representations" in the way modern vision science might be. Do you think [@karmiloff1990constraints]; [@light1983effects; sitton1992drawing] might be relevant? -->
...
Here we explore children's perceptual representations of object categories and how these change over childhood by examining how they draw familiar object categories. We asked children (age 3-10 years) to draw objects on an iPad, and analyzed their semantic properties in two ways. First, we measure how well adults can recognize the depicted object, finding dramatic and consistent gains in drawing recognizability across this age range. Second, we compare their high-level perceptual features with those of sketches produced by adults. Drawing features were extracted from a pre-trained deep convolutional neural network, allowing us to visualize the representational layout of object categories across age groups using a common feature basis. Together, this work illustrates the promise of examining children's drawings as a rich source of quantitative insight into their developing perceptual and conceptual understanding of objects.
