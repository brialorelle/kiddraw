...
abstract: 
    "How do object category representations change throughout childhood? We used drawings as a way to investigate children's representations of object categories. Children (ages 3-10 years) were asked to draw a wide range of objects (e.g. 'can you draw a chair?') in under 30 seconds. Then, we analyzed how these drawings change across childhood. We found that children became increasingly skilled at producing recognizable drawings, even when controlling for low-level covariates (the amount of ink used, the time spent drawing, and the number of strokes). Next, we used a convolutional neural network optimized to recognize objects to quantify the perceptual similarity between children's and adult's drawings.Overall, we find that children's drawings were most similar to adult's drawings in higher-level layers of the network, supporting the idea that children and adult's drawings are most similar in terms of relatively high-level perceptual features (e.g., the presence of eyes; object parts). Thus, thse results suggest both the ability to produce abstract graphical represenetations of objects is relatively adult-like by middle childhood, and that even the most primitive drawings made by children contain featural similarities to the objects they are trying to depict. Broadly, these results point towards drawing as a promising avenue for investigating object representations in childhood."
...
By the time we're adults, we've acquired a wealth of knowledge about different categories of objects and animals, and we know what they tend to look like. For example, we know that apples tend to be round and that rabbits tend have long, oval-ish ears. And so if one is asked to draw an apple or a rabbit, most people can easily produce something that communicates the essence of this category. Here, we investigate the development of the perceptual schemas that we associate with object categories In other words, what do young children think a "rabbit" looks like, and how does this change throughout childhood?  

In some ways, children's ability to categorize objects appeares well developed by the preschool years. Nonetheless, children's object recognition abilities continue to mature into early adolescence (for reviews, see @nishimura2009; @juttner2016developmental). Children's ability to recognize objects across dramatic changes in viewpoint and lighting does not reach adult levels until almost 12 years of age [@bova2007;@dekker2011dorsal]while  children's ability to process the relationship between objects' parts also has a protracted developmental trajectory. For example, while young children have a bias to categorize novel objects on the basis of part-specific information, older children rely more on the relationship between the object parts [@mash2006]; and even older children have difficulty detecting changes in the propotions of an object's parts in familiar categories (i.e., animals; [@juttner2014late; @juttner2013developmental; @davidoff2002]). Thus, children's representations of common object categories (e.g., cups, cars) may also be undergoing developmental change concurrently. 

In adulthood, drawings can serve a powerful tool to tap internal representations of object categories.For example, consider what one has to do in order to draw a phone – one needs to access the mental representation of “a phone”, distill this into a pictoral format, and plan a sequence of hand movements to effectively convey this visual concept. Furthermore, in order to be recognizable, these drawings have to depict the necessary features to express a given visual concept. Recent computational work supports this intuition that drawings depict the essential perceptual features of visual object categories: deep neural network models of the ventral stream trained purely on photographs can also recognize drawings by non-expert adults, as drawings and photographs generate similar representations in higher-level layers of these models [@fan2015common]. In other words, drawings capture high-level similarity relationships between object categories. Furthermore, adult's drawings can reflect how we experience different object categories. For example, dults tend to draw objects relative to their size in the real-world:  objects that are big in the real-world (e.g., cars) tend to take up more "space" on a canvas than objects that are small in the real-world (e.g., cups) (@konkle2011canonical). 

While drawing has been extensively studied in early childhood, a primary focus has been on when and why children treat drawings as symbolic [@gardner1994arts], and evidence now suggests that young children do attribute rich meanings to their drawings. For example, children will attribute different symbolic content (e.g., “a balloon”, “a lollipop”) to very similar drawings based on what they intended to draw [@bloom1998intention]. Further, children will monitor whether their drawings are adequate symbols for the things they are trying to draw, and will improve their drawings when given feedback that their drawings are not effective at communicating the identity of object [@callaghan1999early]. To our knowlede, no research  has examined whether children's drawings reflect how they are representing objects in the world around them.
...
# General Discussion
We explored how children get better at drawing and how similar their drawings are to adult's drawings. Overall, we found that the capacity to quickly produce graphical representations that communicate object category information isdeveloped by middle childhood. Children produced drawings in under 30 seconds that were recognizable by adults with only the few "strokes" of a pen; older children were better able to produce these graphical abstractions than younger children, though children who took longer to draw produced more recognizable drawings.Further, children's drawings were most similar to adult drawings in the higher-level layers of a deep convolutional neural network trained to recognize objects, suggesting that children and adults drawings share high-level perceptual features useful for basic-level object recognition.
