...
abstract: 
    "How do children's representations of object categories change as they grow older? Children are prolific artists, drawing the world around them from an early age. Here, we use drawings as a window into how children represent objects and examine how children’s drawings change across childhood. We asked (3-10 years) to draw objects (e.g. 'can you draw a chair?') on an iPad interface and analyzed the content and form of these drawings. We found that children became increasingly skilled with age at producing drawings that were recognizable to naïve adults. Further, we found that children’s drawings were most to adult's in later layers of a convolutional neural network, confirming that children’s drawings tend to capture high-level perceptual features useful for recognition. Broadly, these results point towards drawing as a promising avenue for investigating object representations in childhood."
