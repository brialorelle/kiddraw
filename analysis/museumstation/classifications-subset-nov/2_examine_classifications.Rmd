...
double_check <- read.csv('classification-outputs/Resampled-metadata.csv')  %>%
  as.tibble(double_check)
```
...
compiledPlot = ggarrange(cor_by_age_plot,p1,p2,p3, nrow = 1)
# dir.create('plots-nov26')
ggsave('plots-nov26/covariates_by_age.png',compiledPlot, width = 11, height = 4)
