...
def load_features(cohort, layer_num):
    ...
    ## create variable that is unique across age/label combinations
...
if __name__ == "__main__":
    ...
    out.to_csv('classification-outputs/museumstation_subset_classification_age_balanced{}.csv'.format(test_index))