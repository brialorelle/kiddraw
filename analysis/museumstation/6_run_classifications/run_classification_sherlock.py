...
def load_features(cohort, layer_num):
    ...
    F = np.load('/home/groups/mcfrank/kiddraw/cnn-features/FEATURES_{}_{}_Spatial_True.npy'.format(DATASET,layers[layer_num],cohort))
    M = pd.read_csv('/home/groups/mcfrank/kiddraw/cnn-features/METADATA_{}.csv'.format(DATASET, cohort)) 
...
def get_classifications(test_index):
    ...
    out.to_csv(os.path.join(out_path_specific,'museumstation_classification_ind_age_balanced_{}.csv'.format(test_index_numeric)))
