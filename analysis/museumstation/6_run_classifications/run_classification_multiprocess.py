...
def load_features(cohort, layer_num):
    ...
    F = np.load('/data5/bria/kiddraw_datasets/{}/FEATURES_{}_{}_Spatial_True.npy'.format(DATASET,layers[layer_num],cohort))
    M = pd.read_csv('/data5/bria/kiddraw_datasets/{}/METADATA_{}.csv'.format(DATASET, cohort)) 
...
#### SPECIFY PARAMETERS
DATASET = 'stringent_cleaned_dataset_features' ## no features yet
LAYER_IND = 6
